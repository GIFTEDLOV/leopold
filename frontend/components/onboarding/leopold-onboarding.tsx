...
const onboardingSlides = [
  {
    ...
    title: "Sign in",
    copy: "Create or access Leopold with email or a wallet. Your account identity and savings wallet stay separate.",
    note: "Signing in never moves funds or connects a financial wallet automatically.",
    accentWords: ["Sign"],
  ...
  },
  {
    ...
    note: "Leopold never creates, auto-connects, or takes custody of your wallet.",
    accentWords: ["wallet"],
  ...
  },
  {
    label: "FUNDING ASSET",
    title: "Get USDC",
    copy: "Have USDC in your verified wallet before entering a savings vault.",
  ...
  },
  {
    ...
    title: "Prize draw",
    copy: "Encrypted onchain randomness selects a winner without exposing private savings positions.",
  ...
  },
  {
    ...
    copy: "Privately reveal your own result while the public outcome remains verifiable.",
  ...
  },
  {
    ...
    copy: "If selected, receive the prize. Otherwise, your principal can keep participating.",
    note: "Prizes come from genuine yield, sponsors, and rollover—not principal.",
    accentWords: ["Win"],
          ...
          >
            {onboardingSlides.map((slide, index) => (
              <article
                ...
                key={slide.label}
                aria-label={`Step ${index + 1} of ${onboardingSlides.length}: ${slide.title}`}
              ...
              >
                ...
                <div className={styles["slide-copy"]}>
                  <div className={styles["board-brand"]}>
                    <Brand />
                  ...
                  <div className={styles["board-intro"]}>
                    ...
                    <div>
                      ...
                      <small aria-live="polite">{String(index + 1).padStart(2, "0")} / {String(onboardingSlides.length).padStart(2, "0")}</small>
                    </div>
                  </div>
                  ...
                  <div className={styles["slide-actions"]}>
                    ...
                    {"complete" in slide && slide.complete ? (
                      ...
                      <>
                        ...
                        <div className={styles["jump-row"]}><Link className={styles["jump-sign-in"]} href="/login">Jump to sign in <span aria-hidden="true">↗</span></Link></div>
                      </>
                    )}
                  </div>
                </div>
