  ...
  return (
    <>
      <meta
        ...
        content={`default-src 'self'; connect-src ${connectSources}${mode === "LIVE_SEPOLIA" ? " data:" : ""}; img-src 'none'; media-src 'none'; object-src 'none'; frame-src 'none'; worker-src 'self' blob:; style-src 'self' 'unsafe-inline'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; base-uri 'none'; form-action 'none'`}
      />
