...
const messages: Record<LeopoldErrorCode, string> = {
  ...
  RELAYER_UNAVAILABLE: "Private operations are temporarily unavailable. Public information may still be available.",
  ...
  RPC_FAILURE: "Sepolia is temporarily unavailable. Your funds are unchanged. Try again shortly.",
  RPC_CONFIGURATION_ERROR: "Sepolia is temporarily unavailable. Your funds are unchanged. Try again shortly.",
  APP_RPC_UNAVAILABLE: "Sepolia is temporarily unavailable. Your funds are unchanged. Try again shortly.",
