...
export default defineConfig({
  ...
  projects: [{ name: "chromium", use: { ...devices["Desktop Chrome"], ...(process.env.SG5_BROWSER_EXECUTABLE ? { executablePath: process.env.SG5_BROWSER_EXECUTABLE } : {}) } }],
  webServer: process.env.SG5_EXTERNAL_SERVER === "1" ? undefined : {
